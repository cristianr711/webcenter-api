...
const app = express();
const VERSION = '2.2.0-vercel-api-fix'; // Version para debug
...
app.get('/api/productos', async (req, res) => {
    try {
        ...
        res.status(500).json({ error: 'Error al cargar productos.', detail: err.message, code: err.code, version: VERSION });
    }
});
